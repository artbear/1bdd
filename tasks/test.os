...
Функция ПрогнатьФичи(Знач ИспользуетсяПокрытиеКода, Знач ПутьФич = "features", Знач ПутьОтчетаJUnit = "./bdd-log.xml")
...
Попытка
	ФичиПрошли = ПрогнатьФичи(ИспользуетсяПокрытиеКода, "features/core");
Исключение
	ФичиПрошли = Ложь;

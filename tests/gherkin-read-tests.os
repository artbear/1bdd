...
Процедура Тест_ДолженПрочитатьПростойФайлФичи() Экспорт
	...
	Ожидаем.Что(Шаг0.ТипШага, "Ожидали, что правильно нашли Сценарий0.ТипШага, а это не так").Равно(ВозможныеТипыШагов.Шаг);
	...
	Ожидаем.Что(Шаг1.ТипШага, "Ожидали, что правильно нашли Сценарий0.ТипШага, а это не так").Равно(ВозможныеТипыШагов.Шаг);

...
Функция ПолучитьСписокТестов(Знач ЮнитТестирование) Экспорт
	...
	МассивТестов.Добавить("Тест_ДолженПрочитатьФайлФичиСоЧисловымиПараметрами");
...
Процедура Тест_ДолженПрочитатьФайлФичиСоЧисловымиПараметрами() Экспорт
	//ВключитьОтладкуЧитателя(УровниЛога.Отладка);

	ФайлФичи = Новый Файл(ОбъединитьПути(ТекущийСценарий().Каталог, "fixtures\ЧисловыеПараметры.feature"));

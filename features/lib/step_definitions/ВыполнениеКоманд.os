...
Процедура ЯСохраняюЗначениеВПеременную(Знач Значение, Знач ИмяПеременной) Экспорт
	Значение = ЗначениеСУчетомПеременныхКонтекста(Значение);
...
Процедура ЗначениеРавно(Знач Значение1, Знач Значение2) Экспорт
	...
	// Значение1 = ЗначениеСУчетомПеременныхКонтекста(Значение1);
	// Значение2 = ЗначениеСУчетомПеременныхКонтекста(Значение2);

	// Ожидаем.Что(Значение1,
	// 	"Ожидали, что значения равны, а это не так")
	// 	.Равно(Значение2);
КонецПроцедуры
...
//TODO избавиться от метода ЗначениеСУчетомПеременныхКонтекста
Функция ЗначениеСУчетомПеременныхКонтекста(Знач Значение)
	Возврат БДД.ЗначениеСУчетомПеременныхКонтекста(Значение);
КонецФункции

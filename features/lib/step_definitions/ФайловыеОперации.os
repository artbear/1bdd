...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ФайлСодержитXmlСтроку");
...
//Файл "folder0/file01.txt" содержит xml строку "Текст файла"
Процедура ФайлСодержитXmlСтроку(Знач ПутьФайла, Знач ЧтоИщем) Экспорт
	ПутьФайла = БДД.ПолучитьПутьФайлаСУчетомПеременныхКонтекста(ПутьФайла);
	ПутьФайла = ЗаменитьШаблоныВПараметрахКоманды(ПутьФайла);

...
Сценарий: После ошибочного шага следующие шаги сценария не выполняются
	Когда установил каталог проекта "tests\fixtures" как текущий
	...
	И в лог-файле запуска продукта есть строка "1 Шаг ( 0 Пройден, 0 Не реализован, 1 Сломался, 0 Не выполнялся )"

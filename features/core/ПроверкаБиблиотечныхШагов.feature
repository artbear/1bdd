...
Структура сценария: <Сценарий>
  ...
  Когда я запустил выполнение фичи "ФичаБезШагов" с передачей параметра <ПараметрКоманднойСтроки>
	Тогда проверка поведения фичи "ФичаБезШагов" закончилась с кодом возврата 0

Примеры:
	| Сценарий | ПараметрКоманднойСтроки |
	| Библиотечные шаги находятся в одном файле | -require СтруктураСценария.feature |
...
# 
#   Когда я запустил выполнение фичи "ФичаБезШагов" с передачей параметра "-require lib"
# 	Тогда проверка поведения фичи "ФичаБезШагов" закончилась с кодом возврата 0
# 
# Сценарий: Автоматическая загрузка всех шагов как библиотечных из подкаталогов каталога фичи
# 
#   Когда я запустил выполнение фичи "ФичаБезШагов" с передачей параметра ""
# 	Тогда проверка поведения фичи "ФичаБезШагов" закончилась с кодом возврата 0

...
Процедура ЯПолучилНаборФичИзКаталогаФичПроектаИсключаяТекущуюФичу() Экспорт
	 НаборФичКаталогаПроекта = НайтиФайлы(ОбъединитьПути(ТекущийСценарий().Каталог, ".."), "*.feature");
...
Процедура ПроверкаПоведенияКаждойФичиИзНабораФичЗакончиласьСКодомВозврата(ПарамЧисло1) Экспорт

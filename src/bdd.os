...
Функция ВыполнитьКоманду(Знач Команда, Знач ПутьФичи, Знач Параметры)
	...
	ИначеЕсли Команда = "gen" Тогда
		СоздатьФайлРеализацииШагов(ПутьФичи, Параметры["-require"]);
...
Процедура СоздатьФайлРеализацииШагов(Знач ПутьФичи, Знач ПутьКБиблиотекам)
	Лог.Отладка("ПутьФичи "+ПутьФичи);
	...
	//ГенераторШагов = ЗагрузитьСценарий(ПутьГенератора, Контекст);
	...
	ФайлШагов = ГенераторШагов.СоздатьФайлРеализацииШагов(ФайлФичи, ФайлБиблиотек);
КонецПроцедуры

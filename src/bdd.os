...
Функция ВыполнитьКоманду(Знач Команда, Знач ПутьФичи, Знач Параметры)
	...
	Если Команда = "exec" Тогда
		КодВозврата = ВыполнитьФичу(ПутьФичи, Параметры["-require"], Параметры["-fail-fast"]);
...
Лог.Предупреждение("ИспользоватьБыстрыйОстановНаОшибке %1", ИспользоватьБыстрыйОстановНаОшибке);
	...
	РезультатыВыполнения = ИсполнительБДД.ВыполнитьФичу(ФайлФичи, ФайлБиблиотек, ИскатьВПодкаталогах, ИспользоватьБыстрыйОстановНаОшибке);

...
Функция СоздатьФайлРеализацииШагов(Знач ФайлФичи, Знач ФайлБиблиотек) Экспорт
	Лог.Отладка("Подготовка к генерации шагов спецификации "+ФайлФичи.ПолноеИмя);
		...
		Ожидаем.Что(ФайлБиблиотек, "Ожидали, что файл библиотек будет передан как файл, а это не так").ИмеетТип("Файл");

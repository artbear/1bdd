...
Перем ПереназначенныйСтатусВыполнения;
...
// Устанавливает статус выполнения шага независимо от его фактического результата выполнения
//
// Параметры:
//   СтатусВыполнения - Строка - Одно из значений структуры ВозможныеСтатусыВыполнения
//
Процедура ПереназначитьСтатусВыполнения(Знач СтатусВыполнения) Экспорт
	ПереназначенныйСтатусВыполнения = СтатусВыполнения;
КонецПроцедуры
// }
...
Функция ВыполнитьШагСценария(Знач АдресШага, Знач ПараметрыШага, Знач НаборБиблиотечныхШагов, 
	...
	СтатусВыполнения = ВозможныеСтатусыВыполнения.НеВыполнялся;
	ПереназначенныйСтатусВыполненияВерхнегоУровня = ПереназначенныйСтатусВыполнения;
	ПереназначенныйСтатусВыполнения = Неопределено;
	...
	Иначе
		...
		Иначе
			...
			Попытка
				...
				СтатусВыполнения = ВозможныеСтатусыВыполнения.Пройден;
				Если ЗначениеЗаполнено(ПереназначенныйСтатусВыполнения) Тогда
					Лог.Отладка("Переопределение статуса шага %1: %2", АдресШага, ПереназначенныйСтатусВыполнения);
					СтатусВыполнения = ПереназначенныйСтатусВыполнения;
				КонецЕсли;
	...
	ПереназначенныйСтатусВыполнения = ПереназначенныйСтатусВыполненияВерхнегоУровня;

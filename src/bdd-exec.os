...
Функция РекурсивноВыполнитьШаги(Знач ФайлСценария, Знач НаборБиблиотечныхШагов, Знач Узел)
	...
	ХукВыполненУспешно = ВыполнитьХукУзла_ПередВыполнением(ФайлСценария, Узел);
...
Функция ВыполнитьХукУзла_ПередВыполнением(Знач ФайлСценария, Знач Узел, Знач ПредставлениеШага = "")
	Рез = Истина;
	Если Узел.ТипШага = ВозможныеТипыШагов.Сценарий Тогда
		...
		Если ОписаниеИсполнителяШагов <> Неопределено Тогда
			...
			АдресХука = "ПередЗапускомСценария";
			...
			Исключение
				...
				текстОшибки = ПодробноеПредставлениеОшибки(Инфо); //ОписаниеОшибки();

...
Функция ВыполнитьФичу(Знач ПарамФайлФичи, Знач ФайлБиблиотек = Неопределено, Знач ИскатьВПодкаталогах = Истина, 
	Знач арамИспользоватьБыстрыйОстановНаОшибке = Ложь, Знач арамИмяЭлементаСценария = "") Экспорт
	
	ФайлФичи = ПарамФайлФичи;
	ИспользоватьБыстрыйОстановНаОшибке = арамИспользоватьБыстрыйОстановНаОшибке;
	ИмяЭлементаСценария = арамИмяЭлементаСценария; 
...
Функция ВыполнитьФичуСУчетомБиблиотечныхШагов(Знач ФайлФичи)
	...
	НовыйНаборБиблиотечныхШагов = ДополнитьНаборШаговИзИсполнителяШаговФичи(ФайлФичи, НаборБиблиотечныхШагов, ОписаниеИсполнителяШагов);
	...
	Иначе
		...
		Если СтатусВыполнения <> ВозможныеСтатусыВыполнения.Сломался Тогда
			Для Каждого СтрокаДерева Из Узел.Строки Цикл
				...
				ВыходитьПриНеудачномВыполнении = ИспользоватьБыстрыйОстановНаОшибке Или СтрокаДерева.ТипШага = ВозможныеТипыШагов.Шаг;

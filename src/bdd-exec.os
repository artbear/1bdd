...
Функция ВыполнитьФичу(Знач ФайлФичи, Знач ФайлБиблиотек = Неопределено, Знач ИскатьВПодкаталогах = Истина, Знач ИспользоватьБыстрыйОстановНаОшибке = Ложь) Экспорт
	...
	Если ФайлФичи.ЭтоКаталог() Тогда
		...
		Для каждого ФайлФичи Из МассивФайлов Цикл
			...
			КонецЕсли;
			РезультатВыполнения = ВыполнитьФичуСУчетомБиблиотечныхШагов(ФайлФичи, НаборБиблиотечныхШагов, ИспользоватьБыстрыйОстановНаОшибке);
	...
	Иначе
		...
		РезультатыВыполнения = ВыполнитьФичуСУчетомБиблиотечныхШагов(ФайлФичи, НаборБиблиотечныхШагов, ИспользоватьБыстрыйОстановНаОшибке);
...
Функция ВыполнитьФичуСУчетомБиблиотечныхШагов(Знач ФайлФичи, Знач НаборБиблиотечныхШагов, Знач ИспользоватьБыстрыйОстановНаОшибке)
	...
	РезультатыВыполнения = ВыполнитьДеревоФич(ФайлФичи, НаборБиблиотечныхШагов, ИспользоватьБыстрыйОстановНаОшибке, РезультатыРазбора);
...
Функция ВыполнитьДеревоФич(Знач ФайлСценария, Знач НаборБиблиотечныхШагов, Знач ИспользоватьБыстрыйОстановНаОшибке, РезультатыРазбора)
	...
	РезультатыВыполнения.Строки[0].СтатусВыполнения = РекурсивноВыполнитьШаги(ФайлСценария, НаборБиблиотечныхШагов, РезультатыВыполнения.Строки[0], ИспользоватьБыстрыйОстановНаОшибке);
...
Функция РекурсивноВыполнитьШаги(Знач ФайлСценария, Знач НаборБиблиотечныхШагов, Знач Узел, Знач ИспользоватьБыстрыйОстановНаОшибке)
	...
	Иначе
		...
		Если СтатусВыполнения <> ВозможныеСтатусыВыполнения.Сломался Тогда
			Для Каждого СтрокаДерева Из Узел.Строки Цикл
				НовыйСтатус = РекурсивноВыполнитьШаги(ФайлСценария, НаборБиблиотечныхШагов, СтрокаДерева, ИспользоватьБыстрыйОстановНаОшибке);

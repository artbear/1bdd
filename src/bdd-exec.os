...
//
// Параметры:
//   ПутьФич - Строка - путь к каталогу с фичами или к файлу фичи
...
//   ПутьОтчетаХмл - Строка - <описание параметра>
//
//  Возвращаемое значение:
//   Булево - Успешное тестирование или нет
//
Функция ВыполнитьФичиИзКоманднойСтроки(Знач ПутьФич = "features", Знач ОписаниеПокрытия, Знач ПутьОтчетаХмл = "./bdd-log.xml") Экспорт

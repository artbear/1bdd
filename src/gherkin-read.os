...
Процедура ЗаполнитьДеревоФич(НайденныеЛексемы, СтрокиДерева, Индекс)
	...
	Пока Индекс < НайденныеЛексемы.Количество() Цикл
		...
		ПраваяЧастьСДобавленнымиКлючамиПараметров = ИзвлечьПараметры(ПараметрыОчереднойЛексемы, НайденныеПараметры, ПараметрыДляТаблицы, ЕстьПараметрыДляТаблицы);
		Лог.Отладка("ПраваяЧастьСДобавленнымиКлючамиПараметров "+ПраваяЧастьСДобавленнымиКлючамиПараметров);

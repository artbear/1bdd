...
Процедура ВставитьУзелКонтекста(Знач МассивСтрокДляВставкиКонтекста, Знач СтрокаКонтекста)
	Для каждого СтрокаСценария Из МассивСтрокДляВставкиКонтекста Цикл
		...
		СкопироватьДерево(НоваяСтрока, СтрокаКонтекста);
	КонецЦикла;
КонецПроцедуры
